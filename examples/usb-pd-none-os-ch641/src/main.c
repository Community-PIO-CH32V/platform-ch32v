 ...
 *
 * There is no integrated 5.1K pull-down inside CC2
 ...
 *
 *If CC2 is selected, make sure the hardware circuit PB1 pin is externally connected to 5.5 K pull-down resistance
 *
